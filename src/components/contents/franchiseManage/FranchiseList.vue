    ...
    export default class FranchiseList extends Vue {
        ...
        created(){
            ...
            if(sessionStorage.role == '0002') { //현금영수증 사업자
                ...
                this.soluDis = true;
            }else if(sessionStorage.role == '0004' || sessionStorage.role == '0005'){ //가맹점관리자,지점관리자 영수증사업자 셋팅
                this.soluVal = sessionStorage.soluId == null ? '' : sessionStorage.soluId;
                this.soluDis = true;
            }
            ...
            this.listItem =  // 그리드 서치 페이징 옵션 처리 데이터 매우중요 이룰을 어기면 화면깨짐이 발생합니다
                {
                    ...
                    search: [
                        ...
                        {type: 'selectCode' ,class:'w33 text_left', title :'가맹점상태',id: 'gajumStatus', name:'gajumStatus' , value: '' ,  api : 'code/storestatus' , option : [{ codeNm : '' , code: '0' }]},
                        ...
                        {type: 'select' ,class:'w33', title :'검색',id: 'searchType', name:'searchType' , value: '' ,  api : '' , option : [{ name : '사업장명' , value: '0' },{ name : '사업자등록번호' , value: '1' },{name : '대표자명' , value: '2' }]},
