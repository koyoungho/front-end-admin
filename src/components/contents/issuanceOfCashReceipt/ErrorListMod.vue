            ...
            this.listItem =  // 그리드 서치 페이징 옵션 처리 데이터 매우중요 이룰을 어기면 화면깨짐이 발생합니다
                {
                    ...
                    search: [
                        {type: 'date3',class:'w33 text_center', title :'원거래승인일자',  id: 'searchOriSaleStartsDate',id2:'searchOriSaleEndDate', name:'searchDate', searchStartDate: [] , calenderCount : 2 , dateType : 'date' , width : 220 , default :'YYYY-MM-DD'},
                        {type: 'popup',class:'w33 ', title :'사업자등록번호', id: 'saupId', name:'사업자번호' , value: '',   api : '' },
                        {type: 'inputPop',class:'w33 text_left', title :'', id: 'shopNm', name:'매장정보' , value: '',   api : ''  },


                        {type: 'date3',class:'w33 text_center', title :'거래일자', id: 'searchSaleStartDate',id2:'searchSaleEndDate', name:'searchDate', searchStartDate: [] , calenderCount : 2 , dateType : 'date' , width : 220  , default :'YYYY-MM-DD'},
                        {type: 'selectCode' ,class:'w33 text_center', title :'오류코드',id: 'errorCode', name:'issuePurpose' , value: '' ,  api : 'code/taxerror' , option : [{ codeName : '소득공제' , code: '0' },{codeName : '지출증빙' , code: '1' }]},
                        {type: 'input2',class:'w33 text_center', title :'오류내용', id: 'errorCodeNm', name:'inputType' , value: '',   api : '' , option : '' },

                        {type: 'select',class:'w25 text_center' , title :'오류구분',id: 'errorType', name:'searchType' , value: '' ,  api : '' , option : [{ name : '전체' , value: 'all' },{name : '국세청' , value: 'tax' },{name : '내부오류' , value: 'inner' }]},
                        {type: 'input2',class:'w25 text_center', title :'거래금액', id: 'totAmt', name:'inputType' , value: '',   api : '' , option : '' },
                        {type: 'input2',class:'w25 text_center', title :'승인번호', id: 'errorPerm', name:'inputType' , value: '',   api : '' , option : '' },
                        {type: 'input2',class:'w25 text_center', title :'원거래승인번호', id: 'oriPerm', name:'inputType' , value: '',   api : '' , option : '' },
                        ...
                        {type: 'hidden',class:'w25 text_center', title :'원거래승인번호', id: 'searchErrorYearMonth', name:'inputType' , value: this.getData['date'],   api : '' , option : '' },
