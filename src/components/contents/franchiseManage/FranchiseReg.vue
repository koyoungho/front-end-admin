            ...
            <div class="tbl_view_box">
                ...
                <table class="tbl_view01">
                    ...
                    <tr>
                        ...
                        <td class="vtop"><input type="text" class="input form_w100" title="사업장명" v-model="storeNm" maxlength="20"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" id="" class="btn_s01 bg04" v-on:click="subSaupPop" title="회사코드">회사코드 등록</button>
...
-->
            ...
            <!-- btn bot -->
            <div class="btn_bot">
                <button type="button" class="btn_b01 bg01" v-if="regbtnShow" v-on:click="validationChk" title="가맹점 등록">가맹점 등록</button>
            </div>
