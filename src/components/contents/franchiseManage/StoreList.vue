<template>
    ...
    <section id="container">
        ...
        <div class="content">
            ...
            <!-- search box -->
            <div class="search_box page_store03">
                <ul class="search_list">
                    <li>
                        <label for="">가맹점</label>
                        <select id="" name="" class="select sch_w100" title="가맹점">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>01</option>
                    ...
                    <li>
                        <label for="">지점</label>
                        <select id="" name="" class="select sch_w100" title="지점">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>01</option>
                    ...
                    <li>
                        <label for="">매장 상태</label>
                        <select id="" name="" class="select sch_w100" title="매장">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>01</option>
