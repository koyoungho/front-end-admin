    ...
    <section id="container">
        ...
        <div class="content">
                ...
                <table class="tbl_view01">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            (단일 최대 건수 <input type="text" class="input form_app02" placeholder="건수(1000건 단위)" title="건수" v-model="aproCnt" maxlength="4"> )
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="btn_bot">
                ...
                <button type="button" id="" class="btn_b01 bg03" v-if="btnUpdShow" v-on:click="validationChk">승인대역 범위 수정</button>
                <button type="button" id="" class="btn_b01 bg03" v-if="btnDelShow" v-on:click="deleteInfo">승인대역 범위 삭제</button>
            </div>
...
<script lang="ts">
    ...
    export default class ApprovalBandScopeDetl extends Vue {
        ...
        created() {
            ...
            console.log('승인대역 범위 수정 권한 확인 ?? :: ' + this.btnUpdShow)
            console.log('승인대역 범위 삭제 권한 확인 ?? :: ' + this.btnDelShow)
