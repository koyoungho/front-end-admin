    ...
    <section id="container">
        ...
        <div class="content">
            ...
            <div class="btn_top" v-if="regbtnShow">
                <button type="button" id="" class="btn_m01 bg05" v-on:click="bulkReg" title="매장 일괄 등록">매장 일괄 등록</button>
            </div>
            ...
            <div class="btn_tbl_bot">
                <button type="button" id="" class="btn_m01 bg01 sch" v-on:click="gajiBox(postText)" v-if="franchiseSerchBtn" title="가맹점 검색">가맹점 검색</button>
            </div>
                        ...
                        <td colspan="3">
                            <ul class="address_list">
                                <li class="con01">
                                    ...
                                    <button type="button" id="" class="btn_s01 bg03" v-on:click="addressBox(postText)" title="주소검색">우편번호</button>
                                </li>
                                <li class="con02">
...
임시 주석 처리 -->
            ...
            <div class="btn_bot" v-if="regbtnShow">
                <button type="button" id="" class="btn_b01 bg01" v-on:click="validationChk" title="매장 등록">매장 등록</button>
            </div>
...
<script lang="ts">
    ...
    @Component({
        components: {
            StoreReg, AddressBox, GajijumBox, CompanyCodePop
        },
    })
...
임시 주석 처리 */
        ...
        insertInfo() {
            ...
            reqData['jijumSaupId'] = this.jijumNo; //지점 사업자번호
            ...
            saupData['subSaup'] = this.loadCodeList; //this.subCompany; //사업자구분
...
임시 주석 처리 */
        ...
        validationChk(){
            ...
            if(this.soluId == ''){
                ...
                alert('법인등록번호를 입력하세요.');
                return;
            }else if(this.saupType == '1' && this.lawNum.length != 13){ //법인사업자 경우만 체크
