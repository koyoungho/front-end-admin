<template>
    ...
    <section id="container">
        ...
        <div class="content">
            ...
            <!-- search box -->
            <div class="search_box page_store02">
                <ul class="search_list">
                    ...
                    <li>
                        <label for="">지점상태</label>
                        <select id="" name="" class="select sch_w100" title="지점상태">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>01</option>
                    ...
                    <li>
                        <label for="">BL 상태</label>
                        <select id="" name="" class="select sch_w100" title="BL 상태">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>01</option>
                    ...
                    <li>
                        <label for="">등록일</label><span class="form_cal"><input type="text" title="날짜 입력" class="input date"></span><span class="period_cal">-</span><span class="form_cal"><input type="text" title="날짜 입력" class="input date"><a href="#" id="datepicker-trigger" class="btn_cal">달력</a></span>
                    </li>
                    <li>
                        <label for="">검색</label>
                    ...
                    <li>
                        <input type="text" class="input sch_appuser" title="고객명 입력">
                    </li>
                </ul>
            </div>
            <!-- //search box -->
            ...
            <div class="tbl_list_box">
                ...
                <table class="tbl_list01">
                    ...
                    <tr>
                        ...
                        <th scope="col">BL 상태</th>
                        <th scope="col">등록일</th>
                    </tr>
                    </thead>
                    <tbody v-on:click="goDetl">
                    <tr>
                        <td>100</td>
                        <td>롯데정보통신</td>
                        <td>132-**-**232</td>
...
<script lang="ts">
    ...
    export default class BranchList extends Vue {
        ...
        //가맹점 상세이동
        goDetl(){
            this.$router.push('/home/branchDetl')
        }
