        ...
        listItem: any =  // 그리드 서치 페이징 옵션 처리 데이터 매우중요 이룰을 어기면 화면깨짐이 발생합니다
            {
                ...
                search: [
                    ...
                    {type: 'date', title :'오류발생월', id: 'datea' , name:'searchDate', searchStartDate: [new Date()] , calenderCount : 1 , dateType : 'month' , width : 140 ,default :'YYYY-MM'},
                    ...
                    {type: 'date', title :'거래일자', id: '123', name:'searchDate', searchStartDate: [new Date(),new Date()] , calenderCount : 2 , dateType : 'date' , width : 220  , default :'YYYY-MM-DD'},
                    ...
                    {type: 'date', title :'원거래승인일자', id: 'sdfsdf', name:'searchDate', searchStartDate: [new Date(),new Date()] , calenderCount : 2 , dateType : 'date' , width : 220 , default :'YYYY-MM-DD'},
