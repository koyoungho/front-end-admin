                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <ul class="address_list">
                                ...
                                <li class="con02">
                                    <input type="text" class="input form_address01" title="주소 입력" v-model="addr1" maxlength="50">
                                </li>
                                <li class="con03">
                                    <input type="text" class="input form_address02" title="상세 주소 입력" v-model="addr2" maxlength="50">
                                </li>
                            </ul>
                        </td>
                    </tr>
